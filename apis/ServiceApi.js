...
export const newEndpointGET = (Constants, _args, handlers = {}) =>
...
export const useNewEndpointGET = (
  ...
  return useQuery(
    ['serviceNewEndpointGET', args],
    () => newEndpointGET(Constants, args, handlers),
    {
      refetchInterval,
      onSuccess: () =>
        queryClient.invalidateQueries(['serviceNewEndpointGETS']),
    }
  );
};
